...
Find the project folder under `~/REDACTED-VAULT-PATH/Claude/`. Read its `CLAUDE.md` file, focusing on:
...
For the expected Project State structure, see `~/REDACTED-VAULT-PATH/Claude/System/project-claude-template.md`.
...
For details on the ADHD Capture System, see `~/REDACTED-VAULT-PATH/Claude/System/protocols-reference.md`.
