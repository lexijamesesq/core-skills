...
claude plugin install estate-hooks@core
claude plugin enable estate-hooks@core
```
...
Review skills before installing. They load into Claude's context and execute with your permissions. Audit the contents of `plugins/core/skills/`, `plugins/core/agents/`, and `plugins/estate-hooks/hooks/` before use.
